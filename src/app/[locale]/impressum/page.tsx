  ...
  return (
    <section className="pt-6 md:pt-8 pb-12 md:pb-16 min-h-[60vh]">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white dark:bg-[#2a231c] rounded-xl p-5 md:p-8 shadow-sm max-w-2xl mx-auto border border-mattone-cream/50 dark:border-[#3d3229] animate-fade-in-up delay-100">
          <div className="space-y-2 md:space-y-3 text-mattone-text dark:text-gray-300 text-sm md:text-base">
            <p className="font-heading text-lg md:text-xl font-semibold text-mattone-brown dark:text-mattone-cream text-left">{t('company')}</p>
          ...
          <div className="mt-6 md:mt-8 pt-5 md:pt-6 border-t border-mattone-cream dark:border-[#3d3229]">
            <h3 className="font-heading text-base md:text-lg font-semibold text-mattone-brown dark:text-mattone-cream mb-3">{t('bank_title')}</h3>
            <div className="space-y-1 text-mattone-text dark:text-gray-300 text-sm md:text-base">
          ...
          <div className="mt-6 md:mt-8 pt-5 md:pt-6 border-t border-mattone-cream dark:border-[#3d3229]">
            <h3 className="font-heading text-base md:text-lg font-semibold text-mattone-brown dark:text-mattone-cream mb-3">{t('offenlegung_title')}</h3>
            <div className="space-y-1 text-mattone-text dark:text-gray-300 text-sm md:text-base">
